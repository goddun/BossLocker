...
#define TO_RADIAN 3.141592 / (float)180.0 // 라디안 = 파이(==180), 파이 / 180 = 1도
#define TO_DEGREE 180.0/3.141592 
...
#define B1(t)               (((1)-(t)) * ((1)-(t))*((1)-(t)))  
#define B2(t)               ((3) * (t) * ((1) - (t))*((1) - (t)))  
#define B3(t)               ((3) * ((t)*(t)) * ((1) - (t)))
#define B4(t)               ((t)*(t)*(t))
